export const en = {
  ...
  book: {
    ...
    subtitle:
      "To book your visit, please provide your information and select the service you require from the options below.",
    nameLabel: "Name",
    ...
    summaryPrefix: "You are booking a",
    summaryMiddle: "appointment on",
    summaryAt: "at",
